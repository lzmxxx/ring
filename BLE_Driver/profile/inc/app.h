...
/* 仅由 BLE 线程/协议栈回调访问；不改变 app_env 与预编译库的布局。 */
extern uint16_t appm_pending_adv_interval;
#define APP_ADV_FAST_INTERVAL 48U    /* 30ms / 0.625ms */
#define APP_ADV_SLOW_INTERVAL 1600U  /* 1000ms / 0.625ms */
